...
function LP_OPF(dLine::DataFrame, dGen::DataFrame, dNodes::Vector{DataFrame}, nN::Int, nL::Int, bMVA::Int, solver::String, hours::Int, dSolar::Dataframe) 
    ...
    ########## DATA MANAGEMENT ##########
    P_Cost0, P_Cost1, P_Cost2, P_Gen_lb, P_Gen_ub, Gen_Status, P_Demand, G_Solar = dataManagerLP(dGen, dNodes, nN, bMVA, hours, dSolar)
    ...
    for hour in 1:hours
        ...
        P_Demand = dataManagerLP(dGen, dNodes, nN, bMVA, hours, dSolar)[7][hour]

        # Select the power generated by solar PV each hour
        G_Solar = dataManagerLP(dGen, dNodes, nN, bMVA, hours, dSolar)[8][hour]
